...
class Action {
    ...
    [string] PacketType() {
        $PacketTypes = [hashtable] @{ "0" = "Sum"; "1" = "Product"; "2" = "Minimum" ; "3" = "Maximum" ; "4" = "Literal Value" ; "5" = "Greater Than" ; "6" = "Less Than"; "7" = "Equal to" }
        if ($this.Type -eq "Type") { return $PacketTypes[($this.Value.ToString())] } else { return "Not an Operator"}
    }
}
class Step {
...
# $HexString = "C200B40A82" # PacketValue = 3 (Ve=6 Ty=4 Li=2021)
# $HexString = "04005AC33890" # PacketValue = 54 (Ve=1 Ty=6 Id=0 Le=27 Ve=6 Ty=4 Li=10 Ve=2 Ty=4 Li=20)
# $HexString = "880086C3E88112"# PacketValue = 7 (Ve=7 Ty=3 Id=1 Nu=3 Ve=2 Ty=4 Li=1 Ve=4 Ty=4 Li=2 Ve=1 Ty=4 Li=3)
# $HexString = "8A004A801A8002F478" # PacketValue = 16 (Ve=4 Ty=2 Id=1 Nu=1 Ve=1 Ty=2 Id=1 Nu=1 Ve=5 Ty=2 Id=0 Le=11 Ve=6 Ty=4 Li=15)
$HexString = "620080001611562C8802118E34" # PacketValue = 12 (Ve=3 Ty=0 Id=1 Nu=2 Ve=0 Ty=0 Id=0 Le=22 Ve=0 Ty=4 Li=10 Ve=5 Ty=4 Li=11 Ve=1 Ty=0 Id=1 Nu=2 Ve=0 Ty=4 Li=12 Ve=3 Ty=4 Li=13)
# $HexString = "C0015000016115A2E0802F182340" # PacketValue = 23 (Ve=6 Ty=0 Id=0 Le=84 Ve=0 Ty=0 Id=0 Le=22 Ve=0 Ty=4 Li=10 Ve=6 Ty=4 Li=11 Ve=4 Ty=0 Id=1 Nu=2 Ve=7 Ty=4 Li=12 Ve=0 Ty=4 Li=13)
# $HexString = "A0016C880162017C3686B18A3D4780" # PacketValue = 31 (Ve=5 Ty=0 Id=0 Le=91 Ve=1 Ty=0 Id=1 Nu=1 Ve=3 Ty=0 Id=1 Nu=5 Ve=7 Ty=4 Li=6 Ve=6 Ty=4 Li=6 Ve=5 Ty=4 Li=12 Ve=2 Ty=4 Li=15 Ve=2 Ty=4 Li=15)
...
$RelevantActions = $Actions.where{$_.Type -in ("LiteralValue","Type") -and !($_.Type -eq "Type" -and $_.Value -eq 4)}
while ($RelevantActions.Type.Contains("Type")) {
    for ($i = 0; $i -lt $RelevantActions.Count; $i++) {

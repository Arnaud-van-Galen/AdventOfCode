...
foreach ($DataLine in $Data) {
	...
	# $DataLine
	($NumPadPaths.ForEach{$_.Length} | Measure-Object -Minimum).Minimum
	...
	($AllDirPad1Paths.ForEach{$_.Length} | Measure-Object -Minimum).Minimum
	...
	$MinLength = ($AllDirPad2Paths.ForEach{$_.Length} | Measure-Object -Minimum).Minimum
